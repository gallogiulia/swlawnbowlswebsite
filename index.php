...
<head>
  ...
  <title>Southwest Lawn Bowls</title>
      ...
      <div id="sidebar_right">
        ...
        <div class="updates_box">
          ...
          <table border="0" cellpadding="0" cellspacing="0" id="updates">
            ...
            <tr valign="top">
              <td class="results_box"><a href="#">R</a></td>
              <td class="updates_legend">= direct link to results</td>
            </tr>

            <tr>
              <td colspan="3" class="team_sw"><img src="tournaments/entreez.png" alt="" width="12" height="12" class="fltrt_entreez" />Quick link to list of entries: &nbsp;</td>
            </tr>

            <tr>
              <td colspan="3" class="team_sw">&nbsp;&nbsp;Team Southwest Point Events:&nbsp;&nbsp;&nbsp;&nbsp;<img src="tournaments/images/points_men.png" alt="" width="10" height="10" title="men's point events">&nbsp;&nbsp;&amp;&nbsp; <img src="tournaments/images/points_women.png" alt="" width="10" height="10" title="women's point events">&nbsp;</td>
            </tr>
        ...
        <div class="sr_info">
          ...
          <p>For a list of Southwest umpires by club, click on the <strong>Umpires</strong> link in the main menu</p>
          <h4><strong>Tournament Results</strong></h4>
          <p>Find the complete list of results beginning with the 2017 season at the<strong> Tourn.&nbsp;Results</strong> link in the main menu. Prior year results are available on the individual tournament pages that can also be found on the <strong>Calendar</strong>.</p>
        </div><!-- end sr_info -->
